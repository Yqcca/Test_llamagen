...
# Additional practical about VAE training on cifar10
# bash scripts/tokenizer/train_vq.sh --cloud-save-path /home/xiandong/LlamaGen/saved_model --data-path /home/xiandong/Datasets/cifar10/images --image-size 256 --vq-model VQ-16
# bash ./scripts/autoregressive/extract_codes_c2i.sh --vq-ckpt ./pretrained_models/vae/vq_ds16_c2i.pt --data-path /home/xiandong/Datasets/cifar10/images --code-path /home/xiandong/LlamaGen/cifar10_code_c2i_flip_ten_crop --ten-crop --crop-range 1.1 --image-size 384